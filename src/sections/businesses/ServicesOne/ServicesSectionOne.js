...
return(
<Service className="custom-background  business-sec1">
  <Container>
    ...
    <Row className="justify-content-center aos-init aos-animate homepage-provide-feature business-cart1" data-aos="fade-up" data-aos-duration={500} data-aos-delay={500} data-aos-once="true">
      {/* Single Services */}
