...
<Service className="custom-background">
  <Container>
    ...
    <Row className="justify-content-center aos-init aos-animate how-to-get-started-section homepage-provide-feature" data-aos="fade-up" data-aos-duration={500} data-aos-delay={500} data-aos-once="true">
      {/* Single Services */}
