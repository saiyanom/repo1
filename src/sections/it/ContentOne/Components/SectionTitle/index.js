...
export default function SectionTitleBlock({respImg,subTitleProps,titleProps,textProps,subTitle,title,title2,title3,text,...rest}){
return(
<SectionTitle {...rest}>
        ...
        <div className='resp-image'>
          <img src={`${respImg}`} className="w-100"></img>
        </div>
