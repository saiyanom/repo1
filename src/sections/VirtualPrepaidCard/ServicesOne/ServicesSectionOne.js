...
return(
<Service className="custom-background prepaidVirtual-Sec1">
  <Container>
    ...
    <Row className="justify-content-between aos-init aos-animate homepage-provide-feature preVcard" data-aos="fade-up" data-aos-duration={500} data-aos-delay={500} data-aos-once="true">
      {/* Single Services */}
      {content.map(({ title,title2,title3, icon, image, text2, text3, text,cardbg,whiteImage,whiteImageClass,id,linkPage,  }) => {
              return (
              <Col xs="h2" className="col-xl-4 col-lg-4 col-sm-6 col-xs-8 sec1" key={id}>
                <ServicesCard 
                  title={title}
                  title2={title2}
                  title3={title3}
