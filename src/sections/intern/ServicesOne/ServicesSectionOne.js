...
return(
<Service className="custom-background type03 cus-padd1 healthy-Pass Inter-how type02">
  <Container>
    ...
    <Row className="justify-content-center aos-init aos-animate homepage-provide-feature inter-howCart" data-aos="fade-up" data-aos-duration={500} data-aos-delay={500} data-aos-once="true">
      {/* Single Services */}
