  ...
  return (
    <>
      <Navbar.Collapse id="responsive-navbar-nav" {...rest}>
        <Navbar.Toggle aria-controls="responsive-navbar-nav" onClick={rest.handleToggle} className="d-lg-none offcanvas-close" />
        ...
        <div className="shadow-sec" onClick={rest.handleToggle}></div>
      </Navbar.Collapse>
    </>
  );
};
